  ...
  return (
    <div className={cn("border-border mt-3 overflow-hidden rounded-lg border", className)}>
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger className="bg-background flex h-auto w-full items-center justify-between rounded-b-none px-3 py-2 text-sm font-normal hover:bg-accent">
        ...
        <CollapsibleContent className={cn("border-border border-t", "data-[closed]:animate-collapsible-up data-[open]:animate-collapsible-down overflow-hidden")}>
